...
{
    if(pr_list.empty())
    cout<<"No projects yet in the database\n";
    else
    {
      for(auto it:pr_list)
      cout<<endl<<setw(30)<<it.pr_id<<setw(30)<<it.pr_name<<setw(30)<<it.team_mem<<setw(30)<<endl;
    }
}
