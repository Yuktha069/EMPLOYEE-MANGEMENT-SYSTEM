...
system("clear");
	...
	if(pass.compare("user@123")==0)
	{
		...
		int ech;
		string emp_ch;
		void (SALARY::* choice1[4]) ()={&SALARY::add_employee,&SALARY::editdata,&SALARY::view_employee,&SALARY::deldata};
		while(ech!=5)
		{
			cout<<"--------Employee Menu------------\n";
			cout<<"\n1. Add Employee\n2. Edit Employee\n3. View Employee\n4. Delete Employee\n5. Return to main menu\n"; //Employee Submenu
...
system("clear");
	...
	if(pass.compare("user@456")==0)
	{
		...
		int pch=0;
		string proj_ch;
		void (PROJECT::* choice2[4]) ()={&PROJECT::getdata,&PROJECT::edit,&PROJECT::view,&PROJECT::del_project};
		while(pch!=5)
		{
			cout<<"--------project Menu------------\n";
			cout<<"\n1. Add project\n2. Edit project\n3. View project\n4. Delete project\n5. Return to main menu\n"; //Project Submenu
